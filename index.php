...
<body>
    <div class="container">
      <div class="row">
        <!-- Modal HTML -->
        <div id="myModal" class="modal fade" style="margin-left: -150px;">
            <div class="modal-dialog modal-login">
                <div class="modal-content" style="width: 780px;">
                    <div class="modal-header">
                      <label for="">Bienvenidos!! Antes de Comenzar Presta Atencion al video</label>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                    <video width="740" height="460" autoplay controls>
                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                              ...
                              <form>
                                ...
                                <div class="d-flex align-items-center mb-3 pb-1">
                                  <span class="h1 fw-bold mb-0" style="color: #37465D;">Test Psicométrico</span>
                                </div>

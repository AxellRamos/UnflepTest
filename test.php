    ...
    <div class="container">
      ...
      <br>
                  ...
                  <div class="modal-dialog modal-login">
                      <div class="modal-content" style="width: 100%">
                          ...
                          <div class="modal-body" style="text-align: center;">
                            ...
                            <br><br>
                            <p>Oops! <br> Lo siento Se le termino el tiempo presione el boton Fin de Prueba</p>
                            <div class="row">
                              <div class="pt-1 mb-4">
                              <a><button class="btn btn-lg btn-block" type="submit" style="width: 100%; background-color: #046633; color: #ffff;">Fin de Prueba</button></a>
                              </div>
                            </div>
                          </div>
                      </div>
       ...
       <!--Tercera encuesta-->
        ...
        <div class="row">
          <div class="pt-1 mb-4">
          <a><button class="btn btn-lg btn-block" type="submit" name="btnenviar" style="width: 100%; background-color: #046633; color: #ffff;">Fin de Prueba</button></a>
          </div>
        </div>
      </form>
        <br>
